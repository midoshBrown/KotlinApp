...
class SubmitFormActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submitBtn.setOnClickListener {
            ...
            showLoadingBar()
            usr.name = nameEdt.text.toString().trim()
            usr.lastName = lastNameEdt.text.toString().trim()
            usr.phoneEmail = phoneFcbEdt.text.toString().trim()
            val isAllFieldsSubmitted = usr.name != "" && usr.lastName != "" && usr.phoneEmail != "" && usr.year != "none" &&
                    usr.major != "none" && usr.place != "none" && usr.lang != "none"
            ...
            if (isAllFieldsSubmitted) {
                ...
                db.collection("users")
                        ...
                        .addOnSuccessListener {
                            ...
                            saveIsFormSubmittedStateInPrefs()
    ...
    private fun saveIsFormSubmittedStateInPrefs() {
